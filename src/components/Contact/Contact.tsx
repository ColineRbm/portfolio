			...
			<section className="contact" id="contact">
				<div className="contact__inner">
					<div className="contact__left">
						<p className="section-label tab">Contact</p>
						<h2 className="contact__title">
							Envie de construire cette nouvelle aventure ensemble ?
							<br />
							<em className="em-color">Échangeons !</em>
						</h2>
					...
					<div className="contact__right">
						...
						<div className="contact__links">
							...
							<a
								href={`${import.meta.env.BASE_URL}CV_Coline-Rabemihoatra.pdf`}
								target="_blank"
								rel="noopener noreferrer"
